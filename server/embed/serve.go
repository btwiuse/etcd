...
import (
	...
	etcdservergw "github.com/btwiuse/etcd/v3/api/etcdserverpb/gw"
	"github.com/btwiuse/etcd/v3/client/v3/credentials"
	"github.com/btwiuse/etcd/v3/pkg/debugutil"
	"github.com/btwiuse/etcd/v3/pkg/httputil"
	"github.com/btwiuse/etcd/v3/pkg/transport"
	"github.com/btwiuse/etcd/v3/server/etcdserver"
	"github.com/btwiuse/etcd/v3/server/etcdserver/api/v3client"
	"github.com/btwiuse/etcd/v3/server/etcdserver/api/v3election"
	"github.com/btwiuse/etcd/v3/server/etcdserver/api/v3election/v3electionpb"
	v3electiongw "github.com/btwiuse/etcd/v3/server/etcdserver/api/v3election/v3electionpb/gw"
	"github.com/btwiuse/etcd/v3/server/etcdserver/api/v3lock"
	"github.com/btwiuse/etcd/v3/server/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "github.com/btwiuse/etcd/v3/server/etcdserver/api/v3lock/v3lockpb/gw"
	"github.com/btwiuse/etcd/v3/server/etcdserver/api/v3rpc"
